...
public class FixtureCargaDeDatos {
    ...
    private static final Administrador administradorDueñoOrganizacion1 = new Administrador(new Usuario("Organizacion1", "Org1#2021^Admin"), null);
    ...
    private static final Administrador administradorDueñoOrganizacion2 = new Administrador(new Usuario("Organizacion2", "Org2#2021^Admin"), null);
